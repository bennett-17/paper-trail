...
var completionFlags = map[string]string{
	...
	"person":         "--limit --json",
	"risk":           "--input-file --batch --limit --output --graph --html --report-html --graph-csv --entities-csv --graph-graphml --cache-ttl --diff --watch --top --min-weight --indicator --min-corroboration --exclude --exclude-file --fail-on --webhook --summary --no-color --quiet --json",
}
